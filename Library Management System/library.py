"""
Hwedza High Library Management System (single-file)
- GUI: tkinter
...
- Simple animations and modern colors
"""
...
# Admin default credentials (for demo). You can change.
...
def init_db():
    ...
    ''')
    # Admins table (optional) - store hashed password in real system
    c.execute('''
...
class HwedzaApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Hwedza High Library Management System")
    ...
    def build_top_bar(self):
        ...
        title = tk.Label(bar, text="Hwedza High Library System By Makoni", bg=COLORS["panel"], fg=COLORS["white"],
                         font=("Inter", 14, "bold"))
